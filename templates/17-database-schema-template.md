...
**File location:** `product-guidelines/17-database-schema.md`
...
**File Location**: `product-guidelines/17-database-schema/migrations/[filename]`
...
- **Migration Files**: `product-guidelines/17-database-schema/migrations/`
