...
> **Derived from**: output/02-mission.md (North Star = mission outcome quantified)
...
**Why This**: [Connection to mission outcome and user value]
...
**Formula**: `North Star = f(Input 1, Input 2, Input 3)`
