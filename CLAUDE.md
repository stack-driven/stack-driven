...
Session 9.5: /model-application         → 09.5-application-architecture.md, 09.5-essentials
...
- Session 9.5 (application-architecture) reads 00-journey + 02-tech-stack + 02b-essentials + 04-architecture + 07-essentials + 08-essentials
- Session 10 (backlog) reads ALL previous sessions (00-09.5 including 02b) and essentials files
...
- `09.5-application-architecture.md` + `09.5-application-architecture-essentials.md`
...
- Session 9.5 (application-architecture) models services/repositories/controllers from database schema (Session 7) and API contracts (Session 8)
- Session 10 (backlog) reads outputs from Sessions 1-9.5 (including Session 3.5 coding standards and Session 9.5 architecture)
- Session 12 (scaffold) implements tech choices from Session 3, coding patterns from Session 3.5, and generates code skeletons from Session 9.5
...
Session 9 (test-strategy) [reads: 00-08]
  ↓
Session 9.5 (application-architecture) [reads: 00, 02, 02b-essentials, 04, 07-essentials, 08-essentials]
  ↓
Session 10 (backlog) [reads: 00-09.5 including 02b + all essentials files]
  ↓
Session 11 (create-gh-issues) [reads: 10-backlog/]
  ↓
Session 12 (scaffold) [reads: 00-11 including 02b, 09.5-essentials]
  ↓
