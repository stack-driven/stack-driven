...
**DO include**:
- Decisions: Pact workflow, service boundaries, Broker config, versioning strategy
- Specifications: Consumer-driven contract patterns, contract verification setup
- Essential patterns: Contract test organization, contract evolution strategy
- Integration points: How contract testing fits with integration testing
