...
**DO include**:
- Decisions: Load testing tool, Core Web Vitals budgets, N+1 prevention strategy
- Specifications: SLO targets, test scenarios, performance baselines
- Essential patterns: Load test organization, performance monitoring setup
- Integration points: How performance testing informs architecture decisions
